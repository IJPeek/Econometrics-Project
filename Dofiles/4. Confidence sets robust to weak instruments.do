...
Description: This dofile generates the confidence sets that we will use to draw inference with the presence of weak instruments.

Sections:
	1. weakiv for each specification
*/

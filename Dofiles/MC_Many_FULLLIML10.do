...
putexcel C5 = `r(sd)'
 ...
 histogram b, freq normal title("LIML-Strong Instrument, 100 ")  yscale(range(0 80))
 graph save "$output/Monte_Carlos/MC_Many_LIML-STRONG_100.gph", replace

 histogram bful, freq normal title("FULL-Strong Instrument, 100 ") yscale(range(0 80)) 
...
putexcel D5 = `r(sd)'
 ...
 histogram b, freq normal title("LIML-Weaker Instrument, 100 ")  yscale(range(0 80))
 graph save "$output/Monte_Carlos/MC_Many_LIML-Weaker_100.gph", replace

 histogram bful, freq normal title("FULL-Weaker Instrument, 100 ") yscale(range(0 80)) 

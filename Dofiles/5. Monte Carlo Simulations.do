...
postclose `sim'
 ...
 graph save "$output/MC_2SLS_Weak.gph", replace
...
gr combine $output/MC_OLS.gph $output/MC_2SLS_Strong.gph $output/MC_2SLS_Weak.gph $output/MC_2SLS_Weakest.gph, col(2) title("2SLS Monte Carlos with weak instruments") saving(charts1, replace)
